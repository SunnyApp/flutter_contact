...
class FlutterContactPlugin(private val context: Context) : MethodCallHandler,
    ...
    private fun getContacts(query: String?, withThumbnails: Boolean, photoHighResolution: Boolean, result: Result) {
        GetContactsTask(result, resolver = context.contentResolver, withThumbnails = withThumbnails, photoHighResolution = photoHighResolution).execute(query)
    }
